  ...
  const steps = [
    {
      ...
      icon: "wand.and.stars",
      description: "DreamWeaver creates personalized bedtime stories just for your little ones. Each story is unique and tailored to their interests and age.",
    },
    {
      title: "Add Your Child's Profile",
      subtitle: "Help us create the perfect stories",
      icon: "person.crop.circle.badge.plus",
      description: "Tell us about your child so we can create stories that are just right for them - with their favorite things and perfect for their age.",
    },
    {
      title: "Ready to Begin!",
      subtitle: "Everything is set up",
      icon: "sparkles",
      description: "You're all set! Now you can create unlimited personalized bedtime stories that will make bedtime magical.",
    },
  ];
              ...
              {currentStep === 1 && hasChildren && (
                <View style={styles.existingChildrenNote}>
                  ...
                  <Text style={styles.existingChildrenText}>
                    Great! You already have {children.length} child profile{children.length !== 1 ? 's' : ''} set up.
                  </Text>
                </View>
              )}
            </View>
