...
const createAuthStore = () => create<AuthState & AuthActions>((set, get) => ({
  user: null,
  loading: true,
  error: null,
  authLoading: false,
...
describe('Auth Store Logic', () => {
  ...
  describe('Error message mapping', () => {
    const errorMappings = [
      ...
      { code: 'auth/user-not-found', expected: 'No account found with this email. Please check your email or sign up.' },
      { code: 'auth/wrong-password', expected: 'Incorrect password. Please try again.' },
      { code: 'auth/invalid-credential', expected: 'Invalid email or password. Please check your credentials and try again.' },
      ...
      { code: 'auth/operation-not-allowed', expected: 'This sign-in method is not enabled. Please contact support.' },
      { code: 'auth/requires-recent-login', expected: 'Please sign in again to complete this action.' },
    ];
